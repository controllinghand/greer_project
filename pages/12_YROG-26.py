...
def main():
    ...
    st.markdown(
        ...
        **Strategy:**  
        Portfolio holdings are systematically sourced from our **Opportunities_IV** screener, 
        which filters the market to identify companies exhibiting strong opportunity 
        characteristics. This rules-based process prioritizes data-driven selection 
        over discretionary stock picking.
        """
    )


    default_code = "YROG-26"
    ...
    # ----------------------------------------------------------
    # 2026 block must appear right after the header (per your request)
    # ----------------------------------------------------------
    st.divider()
