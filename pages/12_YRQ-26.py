...
st.set_page_config(page_title="YRQ-26 Results", layout="wide")

# ----------------------------------------------------------
# Main
# ----------------------------------------------------------
def main():
    st.title("📊 YRQ-26 Results (You Rock Q Benchmark Fund)")

    st.markdown(
        """
        **YRQ-26** is the You Rock Club benchmark fund.  
        Strategy: **Buy $100,000 of QQQ at the start of 2026 and hold.**
