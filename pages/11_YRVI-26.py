# 11_YRVI_26.py
# ----------------------------------------------------------
# YRVI-26 Results Page (Read-only)
# - Community page for the 2026 You Rock Volatility Income Fund
...
def main():
    ...
    st.markdown(
        """
        Read-only community page for **YRVI-26**.  
        Uses **only**: portfolios, portfolio_events, portfolio_nav_daily.

        **Strategy:**  
        Weekly option positions are systematically sourced from our **Weekly IV Targets** screener, 
        which scans the market for contracts exhibiting favorable implied volatility, liquidity, 
        and premium characteristics. This data-driven process helps prioritize opportunities with 
        strong income potential while maintaining a disciplined selection framework.
        """
    )


    default_code = "YRVI-26"
