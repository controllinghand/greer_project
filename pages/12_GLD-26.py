...
# ----------------------------------------------------------
def main():
    st.title("🥇 GLD-26 Results (Gold Benchmark Fund est. 2026)")

    st.markdown(
        """
        **GLD-26** is a benchmark fund.  
        Strategy: **Buy $100,000 of GLD at the start of 2026 and hold.**
    ...
    with st.sidebar:
        ...
        st.markdown("- Buy **GLD** with **$100,000**\n- Hold (no active trading)")
