...
# ----------------------------------------------------------
def main():
    st.title("₿ BTC-26 Results (Bitcoin Benchmark Fund est. 2026)")

    st.markdown(
        """
        **BTC-26** is a benchmark fund.  
        Strategy: **Buy $100,000 of BTC at the start of 2026 and hold.**
    ...
    with st.sidebar:
        ...
        st.markdown("- Buy **BTC** with **$100,000**\n- Hold (no active trading)")
