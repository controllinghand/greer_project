...
WEBHOOK_YRDG_TRADES = os.getenv("DISCORD_WEBHOOK_YRDG_TRADES")
WEBHOOK_YRPG_TRADES = os.getenv("DISCORD_WEBHOOK_YRPG_TRADES")
...
GROWTH_TRADE_WEBHOOKS = {
    ...
    "YRDG-26": WEBHOOK_YRDG_TRADES,  # 🔥 NEW
    "YROG-26": WEBHOOK_YROG_TRADES,
    "YRPG-26": WEBHOOK_YRPG_TRADES,  # 🔥 NEW
